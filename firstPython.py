...
#User click on cross to close the history
    ...
    close_history = wait.until(
        EC.element_to_be_clickable((By.XPATH, "/html[1]/body[1]/div[4]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/button[1]/span[1]/*[name()='svg'][1]"))
    )
    close_history.click()
...
close_message = wait.until(
    EC.element_to_be_clickable((By.XPATH, "//*[name()='path' and contains(@d,'M799.86 16')]"))
)
close_message.click()
...
#close the open message
close_message = wait.until(
    EC.element_to_be_clickable((By.XPATH, "//span[@aria-label='close']//*[name()='svg']"))
)
close_message.click()
print("Message is now close and come back to the communication page")
time.sleep(5)
